...
+(AGLKTextureInfo *)textureWithCGImage:(CGImageRef)cgImage options:(NSDictionary *)options error:(NSError *)outError
{
    ...
    AGLKTextureInfo *result =
    [[AGLKTextureInfo alloc] initWithName:textureBufferID
...
//loaded from the specified Core Graphics image, cgImage. This function also returns (by reference) the power 2 width and height to be used when initializing an OpenGL ES. The widthPtr and heightPtr arguments must be valid pointers.
                                               ...
                                               size_t *heightPtr)
{
    ...
    // Allocate sufficient storage fro RGBA pixel color data with the power of 2 sizes specified
...
// This function calculates and returns the nearest of 2
// that is greater than or equal to the dimension argument and less than or equal to 1024.
static AGLKPowerOf2 AGLKCalculatePowerOf2ForDimension(GLuint dimension)
{
