...
void main()
{
    ...
    // Pass the two sets of texture coordinates to the fragment shader unmodified;
    vTextureCoord0 = aTextureCoord0.st;
    vTextureCoord1 = aTextureCoord1.st;
    
    // Transform the income vertex positon by the combined model-view-projection matrix to produce a fragment position in the Color Render Buffer
