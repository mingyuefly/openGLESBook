...
// Subclasses should override this implementation to load any OpenGL ES 2.0 Shading Language programs prior to drawing any geometry with the receiver. The override should typically call [self loadShadersWithName:<baseName>] specifying the base name for the desired Shading Language programs.
- (void)prepareOpenGL
{
    
}

// Subclasses should override this implementation to configure OpenGL uniform values prior to drawing any geometry with the receiver.
- (void)updateUniformValues
{
    
}

// If the receiver's OpenGL ES 2.0 Shading Language programs have not been loaded, this method calls -prepareOpenGL. This method configures the OpenGL state to use the receiver's OpenGL ES 2.0 Shading Language programs and then calls -updateUniformValues to update any Shading Language program specific state required for drawing.
- (void)prepareToDraw;
{
    if(0 == self.program)
    {
...
/////////////////////////////////////////////////////////////////
// This method loads and compiles OpenGL ES 2.0 Shading Language programs with the root name aShaderName and the suffixes/extensions "vsh" and "fsh".
