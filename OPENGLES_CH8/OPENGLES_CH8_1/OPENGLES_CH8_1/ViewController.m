...
- (void)viewDidLoad {
    ...
    self.eyePosition = GLKVector3Make(0.0f,
                                      3.0f,
                                      3.0f);
    self.lookAtPosition = GLKVector3Make(0.0f,
                                         0.0f,
                                         0.0f);
    self.upVector = GLKVector3Make(0.0f,
                                   1.0f,
                                   0.0f);
    ...
    // The model mannager loads models and sends the data to the GPU.
...
-(void)preparePointOfViewWithAspectRatio:(GLfloat)aspectRatio
{
    ...
    self.lookAtPosition = GLKVector3Make(0.0f,
                                         1.5f + 3.0f * sinf(0.3f * self.angle),
                                         0.0f);
}
